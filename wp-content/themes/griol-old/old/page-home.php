...
<!-- HERO -->
<section class="hero">
  <img class="hero-img" src="<?php echo $dir; ?>/hero-inspection.jpg" alt="Fire door inspection" width="1920" height="1280">
  ...
  <div class="container-page hero-content fade-up">
    ...
    <h1 class="hero-title">
      Certified Fire Door <span class="text-fire">Inspection</span> &amp; Compliance Specialists
    </h1>
    <p class="hero-subtitle">Protecting people, property and reputation across the UK with FDIS-certified inspections, maintenance and remedial works.</p>
    <div class="hero-actions">
      <a href="<?php echo home_url('/contact'); ?>" class="btn-fire">
        Request Inspection
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
      </a>
      <a href="<?php echo home_url('/contact'); ?>" class="btn-outline">
    ...
    <div class="hero-stats">
      <div><div class="hero-stat-num">15+</div><div class="hero-stat-label">Years of expertise</div></div>
      <div><div class="hero-stat-num">50,000+</div><div class="hero-stat-label">Doors inspected</div></div>
      <div><div class="hero-stat-num">FDIS</div><div class="hero-stat-label">Certified inspectors</div></div>
      <div><div class="hero-stat-num">24/7</div><div class="hero-stat-label">Emergency response</div></div>
    </div>
  </div>
</section>
