...
<!-- WHO WE ARE -->
<section class="container-page" style="padding:5rem 0;display:grid;grid-template-columns:1fr 1fr;gap:3rem;align-items:center;">
  <img src="<?php echo $dir; ?>/fire-door.jpg" alt="Certified fire door" loading="lazy" style="border-radius:1rem;box-shadow:var(--shadow-elegant);width:100%;height:90%;" width="1280" height="896">
  <div>
    <p class="eyebrow">Who We Are</p>
    <h2 style="font-size:clamp(1.875rem,4vw,2.5rem);">Compliance is non-negotiable. We make it manageable.</h2>
    <p style="margin-top:1.25rem;color:var(--muted-fg);line-height:1.7;">Founded by passive fire protection specialists, Griol exists to bridge the gap between regulation and real-world building management. We deliver clear, defensible inspection evidence — and the expert remedial works to close every defect.</p>
    <p style="margin-top:1rem;color:var(--muted-fg);line-height:1.7;">Our team operates exclusively in the fire door sector. That focus means deeper technical expertise, better reporting and faster turnaround for our clients across the UK.</p>
  </div>
</section>
...
<section class="about-promise">
  ...
  <p>When you partner with Griol, you get more than an inspection — you get a long-term compliance partner.</p>
  <a href="<?php echo home_url('/contact'); ?>" class="btn-fire" style="margin-top:2rem;">Talk to our team</a>
</section>
