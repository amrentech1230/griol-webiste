...
<section class="irc-page-section">
  ...
  <div class="irc-hero">
    ...
    <!-- CONTENT -->
    <div class="irc-hero-content">

      <!-- BREADCRUMB -->
      <div class="irc-breadcrumb">
      ...
      <!-- LABEL -->
      <div class="irc-hero-label">
        Transparent Pricing
      </div>

      <!-- TITLE -->
      <h1 class="irc-hero-title">
      ...
      <!-- DESC -->
      <p class="irc-hero-desc">
        Transparent fire door pricing for Greater London and the Home Counties.
  ...
  <!-- FLOATING STATS -->
  <div class="irc-floating-stats-wrapper">

    <div class="irc-floating-stats">
  ...
  <div style="max-width:1250px;margin:0 auto;">
    ...
    <div style="
      ...
      <div style="
        ...
        <div style="
          background:#fee2e2; color:#dc2626; padding:12px 18px; border-radius:999px; font-size:14px; font-weight:700;">
      ...
      <p style="
        color:#4b5563; font-size:18px; line-height:1.9; margin:0 0 35px;">
        ...
        is faster, less disruptive and supports your audit trail with post-remediation certification.
      </p>
      ...
      <div style="
        ...
        <div style="max-width:760px;">
          ...
          <h4 style="
            margin:0 0 12px; color:#fff; font-size:30px; font-weight:800;">
            Same-day minor remedials
          </h4>

          <p style="
            margin:0; color:#d1d5db; line-height:1.8; font-size:17px;">
    ...
    <div class="inspection-pricing-section">
      <span class="eyebrow">
        Inspection Pricing
      </span>

      <h3 class="inspection-pricing-title">
        Fire Door Inspection Costs
      </h3>

      <p class="inspection-pricing-desc">
...
<style>
  ...
  /* CTA FINAL */
  .cta-final-section {
    background: linear-gradient(90deg, #eb1c24 0%, #ff6a1a 100%);
    padding: 90px 20px;
    text-align: center;
    font-family: Arial, sans-serif;
  }
